...
class BiTemporalChangeTool(BaseSpecialistTool):
    ...
    def run(
        ...
        metric_summary = {
            ...
            "total_changed_ha": stats.changed_area_ha,
            "changed_hectares": stats.changed_area_ha,
            ...
            "changed_pct": stats.changed_percentage,
            "builtup_expansion_hectares": builtup_ha,
            "new_builtup_ha": builtup_ha,
            "builtup_hectares": builtup_ha,
            "vegetation_loss_hectares": veg_dec_ha,
            "veg_loss_ha": veg_dec_ha,
            "veg_loss_hectares": veg_dec_ha,
            "vegetation_growth_hectares": veg_inc_ha,
            "veg_gain_ha": veg_inc_ha,
            "water_increase_hectares": water_inc_ha,
            "water_increase_ha": water_inc_ha,
            "water_hectares": water_inc_ha,
            ...
            "overlay_base64": rendered.rgba_base64 or rendered.overlay_base64,
            "blended_overlay_base64": rendered.overlay_base64,
            "explainable_legend": {
        ...
        return ToolResult(
            ...
            visual_overlay_b64=rendered.rgba_base64 or rendered.overlay_base64,
